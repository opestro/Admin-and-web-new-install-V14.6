    ...
    <div class="container">
        ...
        <div class="horizontal-scroll d-flex justify-content-between gap-3 gap-lg-4">
            <div class="d-flex flex-column gap-3 align-items-center text-center">
                <img width="100 " src="{{isset($businessProcessStep[0]) && !empty($businessProcessStep[0]->image) ? getValidImage(path:'storage/app/public/vendor-registration-setting/'.$businessProcessStep[0]->image,type: 'product') : theme_asset('assets/img/media/step1.png')}}" alt="" class="dark-support">
            ...
            <div class="middle-step-of-steps d-flex flex-column gap-3 align-items-center text-center">
                <img width="100 " src="{{isset($businessProcessStep[1]) && !empty($businessProcessStep[1]->image) ? getValidImage(path:'storage/app/public/vendor-registration-setting/'.$businessProcessStep[1]->image,type: 'product') : theme_asset('assets/img/media/step2.png')}}" alt="" class="dark-support">
            ...
            <div class="d-flex flex-column gap-3 align-items-center text-center">
                <img width="100 " src="{{isset($businessProcessStep[2]) && !empty($businessProcessStep[2]->image) ? getValidImage(path:'storage/app/public/vendor-registration-setting/'.$businessProcessStep[2]->image,type: 'product') : theme_asset('assets/img/media/step3.png')}}" alt="" class="dark-support">
